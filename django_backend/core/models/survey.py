...
class SurveyManager(models.Manager):
    def create(self, name, description, anonymous, stakeholder, method, rate=0):
        stakeholdergroup, _ = StakeholderGroup.objects.get_or_create(name="A Stakeholder Group", method=method) # stakeholder = string, should be changed to stakeholder = stakeholder
